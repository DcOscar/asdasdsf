 ...
 * @author Oscar
 */
public class MenuCambiarStockProducto extends Ventana {
...
public MenuCambiarStockProducto(){
super("SIVU",500,400);
...
super.generarJLabel(this.textoPrecioProducto, "Nuevo stock producto:", 20,250,200,20);
}
